 ...
 *
 * Disassembly of SSDT12, Fri Jan 31 09:29:17 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "Wwan", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.RP05)
    {
        ...
        {
            OperationRegion (PXCS, SystemMemory, M2PC (\_SB.PCI0.RP05._ADR ()), 0x20)
        ...
        Scope (PXSX)
        {
            ...
            {
                OperationRegion (PXCS, SystemMemory, GMIO (\_SB.PCI0.RP05.PXSX._ADR), 0x0480)
                Field (PXCS, AnyAcc, NoLock, Preserve)
                {
                    VDID,   16, 
                    DVID,   16, 
                ...
                Sleep (0xC8)
                Notify (\_SB.PCI0.RP05.PXSX, One) // Device Check
                Or (Local0, 0x0100, Local0)
                \_SB.SPC0 (\WGUR, Local0)
                Sleep (0xC8)
                If (LEqual (NEXP, Zero))
                {
                    Store (\WDCT, DCTL) /* \_SB_.PCI0.RP05.PXSX._RST.DCTL */
                    Store (\WLCT, LCTL) /* \_SB_.PCI0.RP05.PXSX._RST.LCTL */
                    Store (\WDC2, DCT2) /* \_SB_.PCI0.RP05.PXSX._RST.DCT2 */
                    Store (\WMXS, MXSL) /* \_SB_.PCI0.RP05.PXSX._RST.MXSL */
                    Store (\WMNS, MNSL) /* \_SB_.PCI0.RP05.PXSX._RST.MNSL */
                }
