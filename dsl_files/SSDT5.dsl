 ...
 *
 * Disassembly of SSDT5, Fri Jan 31 09:29:17 2020
 *
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "Rmv_Batt", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.LPCB.EC.BAT1)
    {
        ...
        Method (_EJ0, 1, NotSerialized)  // _EJx: Eject Device, x=0-9
        {
            If (Arg0)
            {
                Store (0x00, \_SB.PCI0.LPCB.EC.BAT1.B1ST) /* External reference */
                Store (0x01, \_SB.PCI0.LPCB.EC.BAT1.SBLI) /* External reference */
                Store (0x00, \_SB.PCI0.LPCB.EC.BAT1.XB1S) /* External reference */
            }
        }
    }
}
